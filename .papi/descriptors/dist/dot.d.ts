...
type IStorage = {
  System: {
     ...
     */
    Events: StorageDescriptor<[], Anonymize<I2jrp6ei12vd6a>, false, never>;
    /**
  ...
  AuraExt: {
     ...
     */
    RelaySlotInfo: StorageDescriptor<
      [],
      Anonymize<I6cs1itejju2vv>,
      true,
      never
    >;
  };
  ...
  Nfts: {
     ...
     */
    CollectionRoleOf: StorageDescriptor<
      Anonymize<I7svnfko10tq2e>,
      number,
      true,
      never
     ...
     */
    Attribute: StorageDescriptor<
      Anonymize<I4ugih6gb4fmug>,
      Anonymize<Idrr42svup341f>,
      true,
      never
    >;
    /**
     ...
     * Config of an item.
     */
    ItemConfigOf: StorageDescriptor<
      Anonymize<I9jd27rnpm8ttv>,
      bigint,
      true,
      never
  ...
  AssetsFreezer: {
     ...
     */
    FrozenBalances: StorageDescriptor<
      Anonymize<I7svnfko10tq2e>,
      bigint,
      true,
      never
  ...
  AssetRewards: {
     ...
     */
    PoolStakers: StorageDescriptor<
      Anonymize<I7svnfko10tq2e>,
      Anonymize<Id8jl5g9dhjihk>,
      true,
      never
    >;
    /**
...
type ICalls = {
  ...
  Utility: {
     ...
     *event is deposited.
     */
    batch: TxDescriptor<Anonymize<Ic7ck1v09l9ujq>>;
    /**
     ...
     */
    as_derivative: TxDescriptor<Anonymize<I17derqjq4a37r>>;
    /**
     ...
     *- O(C) where C is the number of calls to be batched.
     */
    batch_all: TxDescriptor<Anonymize<Ic7ck1v09l9ujq>>;
    /**
     ...
     *- O(1).
     */
    dispatch_as: TxDescriptor<Anonymize<Ialmd7v4av50f4>>;
    /**
     *Send a batch of dispatch calls.
     ...
     *- O(C) where C is the number of calls to be batched.
     */
    force_batch: TxDescriptor<Anonymize<Ic7ck1v09l9ujq>>;
    /**
     ...
     *The dispatch origin for this call must be _Root_.
     */
    with_weight: TxDescriptor<Anonymize<I9o70c0qbdau1p>>;
  };
  Multisig: {
    /**
     ...
     */
    as_multi_threshold_1: TxDescriptor<Anonymize<If7sk2ugakk2b6>>;
    /**
     ...
     */
    as_multi: TxDescriptor<Anonymize<Ibimg9sma81ang>>;
    /**
     *Register approval for a dispatch to be made from a deterministic composite account if
     *approved by a total of `threshold - 1` of `other_signatories`.
     *
  ...
  Proxy: {
     ...
     */
    proxy: TxDescriptor<Anonymize<I1sltd6cqv1s5q>>;
    /**
     ...
     *- `call`: The call to be made by the `real` account.
     */
    proxy_announced: TxDescriptor<Anonymize<I1luig08vsaqns>>;
  };
  Assets: {
    /**
  ...
  Revive: {
     ...
     */
    dispatch_as_fallback_account: TxDescriptor<Anonymize<I2hssm8tv1s603>>;
  };
  AssetRewards: {
    /**
     ...
     */
    create_pool: TxDescriptor<Anonymize<I74kb3a509j58b>>;
    /**
  ...
  AssetConversionMigration: {
     ...
     *Must be signed.
     */
    migrate_to_new_account: TxDescriptor<Anonymize<I3ip09dj7i1e8n>>;
  };
};
type IEvent = {
  System: {
     ...
     *An extrinsic failed.
     */
    ExtrinsicFailed: PlainDescriptor<Anonymize<Ibncgkhmqmbq6h>>;
    /**
     *`:code` was updated.
     */
  ...
  Utility: {
     ...
     *well as the error.
     */
    BatchInterrupted: PlainDescriptor<Anonymize<I8v56q7re8pj7u>>;
    /**
     ...
     */
    ItemFailed: PlainDescriptor<Anonymize<I6m588sg2388aj>>;
    /**
     *A call was dispatched.
     */
    DispatchedAs: PlainDescriptor<Anonymize<I6jjglabvmk9sv>>;
  };
  Multisig: {
    /**
     ...
     */
    MultisigExecuted: PlainDescriptor<Anonymize<I7bulsgqb0n2i7>>;
    /**
  ...
  Proxy: {
     ...
     */
    ProxyExecuted: PlainDescriptor<Anonymize<I6jjglabvmk9sv>>;
    /**
  ...
  ForeignAssetsFreezer: {
    /**
         ...
         */
    Frozen: PlainDescriptor<Anonymize<I1rnkmiu7usb82>>;
    /**
        
         */
    Thawed: PlainDescriptor<Anonymize<I1rnkmiu7usb82>>;
  };
  PoolAssetsFreezer: {
    /**
  ...
  AssetRewards: {
     ...
     */
    PoolCreated: PlainDescriptor<Anonymize<I7sm6ctq17lb21>>;
    /**
  ...
  AssetConversionMigration: {
     ...
     */
    MigratedToNewAccount: PlainDescriptor<Anonymize<I9al0v2qskkktj>>;
  };
};
type IError = {
  System: {
...
type IRuntimeCalls = {
  ...
  AuraUnincludedSegmentApi: {
     ...
     */
    can_build_upon: RuntimeDescriptor<
      [included_hash: FixedSizeBinary<32>, slot: bigint],
      boolean
    >;
  };
  /**
  ...
  NftsApi: {
    ...
    owner: RuntimeDescriptor<
      [collection: number, item: number],
      Anonymize<Ihfphjolmsqq1>
    >;
    /**
        
         */
    collection_owner: RuntimeDescriptor<
      [collection: number],
      Anonymize<Ihfphjolmsqq1>
    >;
    /**
         ...
         */
    attribute: RuntimeDescriptor<
      [collection: number, item: number, key: Binary],
      Anonymize<Iabpgqcjikia83>
    >;
    /**
        
         */
    custom_attribute: RuntimeDescriptor<
      [account: SS58String, collection: number, item: number, key: Binary],
      Anonymize<Iabpgqcjikia83>
    >;
    /**
        
         */
    system_attribute: RuntimeDescriptor<
      [collection: number, item: Anonymize<I4arjljr6dpflb>, key: Binary],
      Anonymize<Iabpgqcjikia83>
    >;
    /**
        
         */
    collection_attribute: RuntimeDescriptor<
      [collection: number, key: Binary],
      Anonymize<Iabpgqcjikia83>
    >;
  };
  /**
  ...
  AssetConversionApi: {
    ...
    get_reserves: RuntimeDescriptor<
      [asset1: Anonymize<If9iqq7i64mur8>, asset2: Anonymize<If9iqq7i64mur8>],
  ...
  DryRunApi: {
    ...
    dry_run_call: RuntimeDescriptor<
      [origin: Anonymize<I42ficri7uep20>, call: Anonymize<If33vqn8ucfk4q>],
      Anonymize<Iachtn16ol50nu>
    >;
    /**
     * Dry run XCM program
     */
  ...
  TransactionPaymentCallApi: {
    ...
    query_call_info: RuntimeDescriptor<
      [call: Anonymize<If33vqn8ucfk4q>, len: number],
      Anonymize<I6spmpef2c7svf>
    >;
    /**
  ...
  GetCoreSelectorApi: {
     ...
     */
    core_selector: RuntimeDescriptor<[], FixedSizeBinary<2>>;
  };
  /**
  ...
  ReviveApi: {
    ...
    eth_transact: RuntimeDescriptor<
      [tx: Anonymize<Iafjplr55l4f68>],
      Anonymize<I8abab09ak4pi1>
    >;
    /**
     * Upload new code without instantiating a contract from it.
     *
    ...
    trace_tx: RuntimeDescriptor<
      [
        block: Anonymize<Iaqet9jc3ihboe>,
        tx_index: number,
        config: Anonymize<Ifbmd9e2argcmg>,
      ],
      Anonymize<Ifhkf7u37ati97>
    >;
    /**
    ...
    trace_call: RuntimeDescriptor<
      [tx: Anonymize<Iafjplr55l4f68>, config: Anonymize<Ifbmd9e2argcmg>],
      Anonymize<I85o101eggvfjq>
    >;
  };
};
type IAsset = PlainDescriptor<Anonymize<If9iqq7i64mur8>>;
export type DotDispatchError = Anonymize<I2em38gdd5updn>;
type PalletsTypedef = {
  __storage: IStorage;
  __tx: ICalls;
  __event: IEvent;
...
export type DotCallData = Anonymize<If33vqn8ucfk4q> & {
  value: {
    type: string;
  };
};
